...
-- Indexes
create index idx_payment_history_doctor on public.payment_history(doctor_id);
create index idx_payment_history_event on public.payment_history(chargily_event_id);
